...
The figures on the left correspond to the Jaccard index (top) and Cosine similarity (bottom) between the vocabularies estimated from data coming from a particular country. It also includes the *ALL* vocabulary that corresponds to taking a uniform sample from all the regions.
