...
```{python}
#| echo: false
#| fig-cap: Distribution estimated with DialectId on the Tweets having as geographic informacion Great Italy. 
#| label: fig-fr-it
...
```{python}
#| echo: false
#| fig-cap: Distribution estimated with DialectId on the Tweets having as geographic informacion Great Algeria. 
#| label: fig-fr-dz
